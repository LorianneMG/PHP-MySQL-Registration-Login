  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="home.php" id="register">Register</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="home.php" id="login">Login</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="home.php" id="logout">Log Out</a>
        </li>
      </ul>
